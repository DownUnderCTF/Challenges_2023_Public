# Thank you Joseph, I'm stealing your flipper from last year!
...
upside_down = open('../publish/++ɐ.ɟʇɔnp-oʇ-ǝɯoɔlǝʍ', 'r').read().splitlines()
...
# Flag Instructions to Locator!
print("THE FLAG IS ON THE VARIABLE NAMED 'HappyHour'")
print("Alternatively, run this over at: https://aussieplusplus.vercel.app/")
print(":D")
